            ...
            {step === 1 && (<>
              <div className="am-panel">
                ...
                <div className="am-field">
                  <div className="am-lbl">Card Colour</div>
                  <div className="am-colors">
                    {COLORS.map(({ hex, label }) => (
                      <div key={hex} title={label}
                        className={`am-color-sw ${f.color===hex?"picked":""}`}
                        style={{ background:hex, "--sw-c":hex }}
              ...
              <div className="am-panel">
                ...
                <div className="am-g2">
                  <div className="am-field am-col2">
                    ...
                    <input className="am-input" placeholder="e.g. Metformin, Aspirin, Vitamin D…"
                      value={f.name} onChange={e => set("name", e.target.value)} />
                  </div>
                  <div className="am-field">
                    <div className="am-lbl">Category <span className="am-req">*</span></div>
                    <select className="am-select" value={f.category} onChange={e => set("category", e.target.value)}>
